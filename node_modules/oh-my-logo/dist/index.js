...
function parseJsonPalette(value) {
...
function parseCommaSeparatedPalette(value) {
    const colors = value
        .split(',')
...
function parsePaletteArgument(paletteArg) {
...
function parsePaletteColorsOption(colors) {
...
program
    ...
    .option('--palette-colors <colors>', 'Custom colors as JSON array or comma-separated list')
    ...
    .option('-d, --direction <dir>', 'Gradient direction: horizontal, vertical, or diagonal')
    ...
    try {
        ...
        inputText = inputText.replace(/\\n/g, '\n');
        const paletteInput = options.paletteColors !== undefined && options.paletteColors !== null
